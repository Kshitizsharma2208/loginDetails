    ...
    <DefaultLayout>
      <div className="landing">
        <h1 className="pageTitle">
          Welcome back <b>Rakesh</b>
        </h1>
        <div className="progressContainer">
          <div className="headingLeft">
            <h4 className="headingTop">Target Progress</h4>
            <span className="progress-badge" id="color">
              2 more to go!
            </span>
          ...
          <div className="celebrationSection sectionContainer">
            <div className="appreciate-text">
              ...
              <p>
                {" "}
                <b>Manoj </b> is leading with <b> 7 lead generation </b>
              </p>
            </div>
            <div className="avg-text">
              <img src={hands} alt="" />
              <p>
                Average lead generation this week is <b> 4 lead </b>
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="card1">
              <div className="headingLeft">
                <h4 className="headingTop">
                  {" "}
                  <p className="pt">Work in Progress </p>
                </h4>
                <span className="badge" id="color">
                  3
                </span>
              </div>
              <div className="card">
                  ...
                  <div className="cardFooter footer">
                    ...
                    <div className="containerFooter">
                      ...
                      <div className="rightBottom" id="boxB">
                        ...
                        <p className="value">
                          <b className="lic">LIC of India </b>
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="middleContainer">
            <div className="card2">
              <div className="headingLeft">
                <h4 className="headingTop">
                  {" "}
                  <p className="pt">Pending request </p>{" "}
                </h4>
          ...
          <div className="rightContainer">
            <div className="card-3">
              <div className="headingLeft searchContainer">
                ...
                <p className="p-point">
                  Search customer by there register mobile number or cif number
                </p>
        ...
        <div className="btns-">
          <div className="btns-1">
            <button className="btns-1">View all</button>{" "}
          </div>
          <div className="btns-1">
            <button className="btns-1">View all</button>{" "}
          </div>
        ...
        <div className="bigFooter">
          <div className="footerContainer">
            ...
            <div className="footerRight">
              ...
              <div>
                <img className="calendar" src={down} alt="" />
              </div>
            </div>
          </div>
          <div className="footer-small-container">
            <div className="footer-small-left">
              <div className="message msg1">
                <p>
                  {" "}
                  You are in the <b>top 20% </b> in lead generation{" "}
                </p>
              </div>
